...
//AWS access info
//AWS access info
			if (!defined('awsAccessKey')) define('awsAccessKey', 'AKIAJHGX5BTL447XHW6Q');
			if (!defined('awsSecretKey')) define('awsSecretKey', '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');
                ...
                <ul class="hide-bullets">
                    ...
                    <li class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-0">
                            <img src="https://s3-eu-west-1.amazonaws.com/ndhs3/<?php echo $photo[2]; ?>">
                        </a>
                    </li>
					<?php $i++;} ?>
                </ul>
                            ...
                            <div class="carousel slide" id="myCarousel">
                                ...
                                <div class="carousel-inner">
									<div class="item active" data-slide-number="0">
                                        ...
                                        if (count($photos) != 0) {
                                        ?>
                                            <img src="https://s3-eu-west-1.amazonaws.com/ndhs3/<?php echo $photos[0][2]; ?>" >
                                        <?php }?>
									</div>
								<?php 
								...
								?>
                                    <div class="item" data-slide-number="<?php echo $i;?>">
                                        <img src="https://s3-eu-west-1.amazonaws.com/ndhs3/<?php echo $photos[$i][2]; ?>" >
									</div>
									<?php }?>
                                </div>
                                <!-- Carousel nav -->
